...
function FeedbackResponsive() {


    return (
        <div style={{ flexDirection: 'row', display: 'column', backgroundColor: "#E8E8EA", paddingTop: 80 }}>
            ...
            <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column' }}>
                ...
                <div style={{ fontSize: 30, marginLeft: 16, fontWeight: '600', color: '#020000', lineHeight: 0.9 }}>What our customers <br />are <span style={{ color: '#DF4842' }}>saying...</span></div>

                <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', alignItems: 'center' }}>
                    {reviews.map((review, index) => {
                        return <div>
                            <div style={{ width: '80%', margin: 16, padding: 16, backgroundColor: '#fff', borderRadius: 12, display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', position: 'relative' }}>
                                <img src={brush_mark} style={{ alignSelf: 'center', objectFit: 'cover', height: '100%', paddingRight: 12, position: 'absolute' }} />
                                <div style={{ color: '#000', padding: 16, fontSize: 16, }}>{review.message}</div>
...
export default FeedbackResponsive;
